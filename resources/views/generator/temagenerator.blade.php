...
@section('content')
    ...
    <div class="row" style="padding-top: 80px">
        ...
        <div class="col-md-6 col-sm-12" id="temaSec1">
            <a href="{{route("generators","1")}}" >
                <div style="position: absolute; width: 50%;height: 100%;z-index: 99" id="boyutVer1"></div>
            </a>
            <div class="card">
        ...
        <div class="col-md-6 col-sm-12" id="temaSec2">
            <a href="{{route("generators","2")}}" >
                <div style="position: absolute; width: 50%;height: 100%;z-index: 99" id="boyutVer2"></div>
            </a>
        ...
        <div class="col-md-6 col-sm-12" id="temaSec3">
            <a href="{{route("generators","3")}}" >
            <div style="position: absolute; width: 50%;height: 100%;z-index: 99" id="boyutVer3"></div>
            </a>
    ...
    <script>
        $(document).ready(function(){
            $("#boyutVer1").width($("#temaSec1").width());
            $("#boyutVer1").height($("#temaSec1").height());
            $("#boyutVer2").width($("#temaSec2").width());
            $("#boyutVer2").height($("#temaSec2").height());
            $("#boyutVer3").width($("#temaSec3").width());
            $("#boyutVer3").height($("#temaSec3").height());
        });
